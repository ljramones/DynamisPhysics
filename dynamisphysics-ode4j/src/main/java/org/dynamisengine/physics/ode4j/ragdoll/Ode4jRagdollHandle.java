...
public final class Ode4jRagdollHandle implements RagdollHandle {
    private final String id;
    private final Map<String, RigidBodyHandle> bones;
    private final Function<String, BodyState> stateLookup;
    private boolean alive = true;

    public Ode4jRagdollHandle(String id, Map<String, RigidBodyHandle> bones, Function<String, BodyState> stateLookup) {
        this.id = id;
