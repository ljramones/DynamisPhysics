...
import org.dynamisengine.physics.api.WheelConfig;
...
import org.dynamisengine.physics.api.event.VehicleAirborneEvent;
import org.dynamisengine.physics.api.event.WheelSlipEvent;
...
public final class Ode4jVehicleSystem {
    ...
    public VehicleState getVehicleState(VehicleHandle h) {
        ...
        List<org.dynamisengine.physics.api.world.WheelState> wheels = oh.internalState().wheelStates
            .stream()
