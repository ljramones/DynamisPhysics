package org.dynamisengine.physics.bench;
...
import org.dynamisengine.physics.api.RagdollBoneDesc;
import org.dynamisengine.physics.api.RagdollDescriptor;
import org.dynamisengine.physics.api.RagdollJointDesc;
...
import org.dynamisengine.physics.api.constraint.MechanicalConstraintBuilders;
import org.dynamisengine.physics.api.material.PhysicsMaterial;
import org.dynamisengine.physics.api.world.PhysicsWorld;
import org.dynamisengine.physics.jolt.JoltBackendRegistrar;
...
final class BenchSupport {
    ...
    private static CollisionShape createGroundMeshShape(float halfExtent) {
        ...
        return CollisionShape.triangleMesh(
            org.dynamisengine.physics.jolt.meshforge.MeshForgeExtractors.extractPositions(packed),
            org.dynamisengine.physics.jolt.meshforge.MeshForgeExtractors.extractIndices(packed)
        );
    }
}
